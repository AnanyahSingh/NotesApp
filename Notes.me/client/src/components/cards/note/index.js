  ...
  return (
    <article className={styles.container} style={{ backgroundColor: color }}>
      <div className={styles.content}>
        {!text.length ? (
          <textarea value={noteText} onChange={handleTextInput} className={styles.textarea}/>
        ) : (
          <>
      ...
      <footer className={styles.footer}>
        ...
        {showSaveBtn?<Button text={'save'} className={styles.saveBtn} handleClick={handleSave}/>:null}
      </footer>
    </article>
  );
}
